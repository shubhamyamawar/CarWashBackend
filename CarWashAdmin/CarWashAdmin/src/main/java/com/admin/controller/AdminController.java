...
import com.washer.models.ListWashers;
...
//	Method to edit washpack by id
	...
	public ResponseEntity<Object> updateWashpacks(@RequestBody WashPacks washPacks) {
		return new ResponseEntity<>(adminServiceImpl.editWashPack(washPacks), HttpStatus.OK);
	}
...
//	*****************************************************************  Another Class
	...
	public ResponseEntity<ListCustomer> listOfCustomers() {
		// return new ResponseEntity<>(adminServiceImpl.listOfCustomers(),
		// HttpStatus.OK);

//    	HttpHeaders headers = new HttpHeaders();
//    	headers.set(null, null);
//    	restTemplate.exchange(null, null, null, null);
		ListCustomer list = restTemplate.getForObject("http://customer-microservice/customer/get-all-customer",
				ListCustomer.class);
